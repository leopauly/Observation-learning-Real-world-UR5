# Check for the connection port using :
#dmesg | grep tty
#Configure the serial port to avoid permission denied errors by
#Adding yourself to the dialout group as follows:
# usermod -a -G dialout YOURUSERNAME

# The follwowing code uses the MODBUS RTU commands to activate, open and close
# the gripper !
