...
struct Lights_
{
  ...
  _lights_type lights;
    ...
    enum { LIGHTS_FRONT_LEFT_UPPER = 0u };
     enum { LIGHTS_FRONT_LEFT_LOWER = 1u };
     enum { LIGHTS_FRONT_RIGHT_UPPER = 2u };
     enum { LIGHTS_FRONT_RIGHT_LOWER = 3u };
     enum { LIGHTS_REAR_LEFT_UPPER = 4u };
     enum { LIGHTS_REAR_LEFT_LOWER = 5u };
     enum { LIGHTS_REAR_RIGHT_UPPER = 6u };
     enum { LIGHTS_REAR_RIGHT_LOWER = 7u };
...
// {'ridgeback_msgs': ['/home/wisdom/catkin_ws/src/ridgeback/ridgeback_msgs/msg'], 'std_msgs': ['/opt/ros/indigo/share/std_msgs/cmake/../msg']}
