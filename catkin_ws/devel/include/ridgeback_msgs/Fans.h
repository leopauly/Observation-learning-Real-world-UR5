...
struct Fans_
{
  ...
  _fans_type fans;
    ...
    enum { EQUIPMENT_BAY_INTAKE = 0u };
     enum { EQUIPMENT_BAY_EXHAUST = 1u };
     enum { CHARGER_BAY_INTAKE = 2u };
     enum { CHARGER_BAY_EXHAUST = 3u };
     enum { USER_BAY_INTAKE = 4u };
     enum { USER_BAY_EXHAUST = 5u };
     enum { FAN_OFF = 0u };
     enum { FAN_ON_HIGH = 1u };
     enum { FAN_ON_LOW = 2u };
