...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_Q7B.pack(_x.timestamp, _x.is_robot_connected, _x.is_real_robot_enabled, _x.is_power_on_robot, _x.is_emergency_stopped, _x.is_protective_stopped, _x.is_program_running, _x.is_program_paused))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.timestamp, _x.is_robot_connected, _x.is_real_robot_enabled, _x.is_power_on_robot, _x.is_emergency_stopped, _x.is_protective_stopped, _x.is_program_running, _x.is_program_paused,) = _struct_Q7B.unpack(str[start:end])
