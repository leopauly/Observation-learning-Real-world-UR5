  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_4i2f6B9fd.pack(_x.mcu_uptime.secs, _x.mcu_uptime.nsecs, _x.connection_uptime.secs, _x.connection_uptime.nsecs, _x.pcb_temperature, _x.mcu_temperature, _x.stop_power_status, _x.stop_engaged, _x.drivers_active, _x.external_stop_present, _x.charger_connected, _x.charging_complete, _x.measured_battery, _x.measured_12v, _x.measured_5v, _x.measured_inverter, _x.measured_front_axle, _x.measured_rear_axle, _x.measured_light, _x.total_current, _x.total_current_peak, _x.total_power_consumed))
