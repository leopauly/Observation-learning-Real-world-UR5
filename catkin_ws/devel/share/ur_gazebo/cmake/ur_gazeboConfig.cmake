...
if("TRUE" STREQUAL "TRUE")
  set(ur_gazebo_SOURCE_PREFIX /home/wisdom/catkin_ws/src/universal_robot/ur_gazebo)
  set(ur_gazebo_DEVEL_PREFIX /home/wisdom/catkin_ws/devel)
  ...
  set(ur_gazebo_INSTALL_PREFIX /home/wisdom/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ur_gazebo' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'G.A. vd. Hoorn <g.a.vanderhoorn@tudelft.nl>, Miguel Prada Sarasola <miguel.prada@tecnalia.com>, Nadia Hammoudeh Garcia <nhg@ipa.fhg.de>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ur_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wisdom/catkin_ws/src/universal_robot/ur_gazebo/${idir}'.  Ask the maintainer 'G.A. vd. Hoorn <g.a.vanderhoorn@tudelft.nl>, Miguel Prada Sarasola <miguel.prada@tecnalia.com>, Nadia Hammoudeh Garcia <nhg@ipa.fhg.de>' to fix it.")
    endif()
