...
if("TRUE" STREQUAL "TRUE")
  set(ur_driver_SOURCE_PREFIX /home/wisdom/catkin_ws/src/universal_robot/ur_driver)
  set(ur_driver_DEVEL_PREFIX /home/wisdom/catkin_ws/devel)
  ...
  set(ur_driver_INSTALL_PREFIX /home/wisdom/catkin_ws/install)
...
if(NOT "/home/wisdom/catkin_ws/devel/include " STREQUAL " ")
  set(ur_driver_INCLUDE_DIRS "")
  set(_include_dirs "/home/wisdom/catkin_ws/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ur_driver' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'G.A. vd. Hoorn <g.a.vanderhoorn@tudelft.nl>, Miguel Prada Sarasola <miguel.prada@tecnalia.com>, Nadia Hammoudeh Garcia <nhg@ipa.fhg.de>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ur_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wisdom/catkin_ws/src/universal_robot/ur_driver/${idir}'.  Ask the maintainer 'G.A. vd. Hoorn <g.a.vanderhoorn@tudelft.nl>, Miguel Prada Sarasola <miguel.prada@tecnalia.com>, Nadia Hammoudeh Garcia <nhg@ipa.fhg.de>' to fix it.")
    endif()
