...
if("TRUE" STREQUAL "TRUE")
  set(joint_limits_interface_SOURCE_PREFIX /home/wisdom/catkin_ws/src/ridgeback/ros_control/joint_limits_interface)
  set(joint_limits_interface_DEVEL_PREFIX /home/wisdom/catkin_ws/devel)
  ...
  set(joint_limits_interface_INSTALL_PREFIX /home/wisdom/catkin_ws/install)
...
if(NOT "/home/wisdom/catkin_ws/src/ridgeback/ros_control/joint_limits_interface/include;/usr/include " STREQUAL " ")
  set(joint_limits_interface_INCLUDE_DIRS "")
  set(_include_dirs "/home/wisdom/catkin_ws/src/ridgeback/ros_control/joint_limits_interface/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'joint_limits_interface' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>, Bence Magyar <bence.magyar.robotics@gmail.com>, Enrique Fernandez <enrique.fernandez.perdomo@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'joint_limits_interface' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wisdom/catkin_ws/src/ridgeback/ros_control/joint_limits_interface/${idir}'.  Ask the maintainer 'Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>, Bence Magyar <bence.magyar.robotics@gmail.com>, Enrique Fernandez <enrique.fernandez.perdomo@gmail.com>' to fix it.")
    endif()
