...
(cl:defmethod command_id-val ((m <sensor_accessor-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotiq_force_torque_sensor-srv:command_id-val is deprecated.  Use robotiq_force_torque_sensor-srv:command_id instead.")
  (command_id m))
...
(cl:defmethod success-val ((m <sensor_accessor-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotiq_force_torque_sensor-srv:success-val is deprecated.  Use robotiq_force_torque_sensor-srv:success instead.")
  (success m))
