...
if("TRUE" STREQUAL "TRUE")
  set(combined_robot_hw_tests_SOURCE_PREFIX /home/wisdom/catkin_ws/src/ridgeback/ros_control/combined_robot_hw_tests)
  set(combined_robot_hw_tests_DEVEL_PREFIX /home/wisdom/catkin_ws/devel)
  ...
  set(combined_robot_hw_tests_INSTALL_PREFIX /home/wisdom/catkin_ws/install)
...
if(NOT "/home/wisdom/catkin_ws/src/ridgeback/ros_control/combined_robot_hw_tests/include " STREQUAL " ")
  set(combined_robot_hw_tests_INCLUDE_DIRS "")
  set(_include_dirs "/home/wisdom/catkin_ws/src/ridgeback/ros_control/combined_robot_hw_tests/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'combined_robot_hw_tests' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Toni Oliver <toni@shadowrobot.com>, Bence Magyar <bence.magyar.robotics@gmail.com>, Enrique Fernandez <enrique.fernandez.perdomo@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'combined_robot_hw_tests' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wisdom/catkin_ws/src/ridgeback/ros_control/combined_robot_hw_tests/${idir}'.  Ask the maintainer 'Toni Oliver <toni@shadowrobot.com>, Bence Magyar <bence.magyar.robotics@gmail.com>, Enrique Fernandez <enrique.fernandez.perdomo@gmail.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${combined_robot_hw_tests_dep}_FOUND)
      find_package(${combined_robot_hw_tests_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${combined_robot_hw_tests_dep} REQUIRED ${depend_list})
  endif()
