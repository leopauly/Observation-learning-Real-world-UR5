...
if("TRUE" STREQUAL "TRUE")
  set(ur5_e_moveit_config_SOURCE_PREFIX /home/wisdom/catkin_ws/src/universal_robot/ur5_e_moveit_config)
  set(ur5_e_moveit_config_DEVEL_PREFIX /home/wisdom/catkin_ws/devel)
  ...
  set(ur5_e_moveit_config_INSTALL_PREFIX /home/wisdom/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ur5_e_moveit_config' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'G.A. vd. Hoorn <g.a.vanderhoorn@tudelft.nl>, Miguel Prada Sarasola <miguel.prada@tecnalia.com>, Nadia Hammoudeh Garcia <nhg@ipa.fhg.de>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ur5_e_moveit_config' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wisdom/catkin_ws/src/universal_robot/ur5_e_moveit_config/${idir}'.  Ask the maintainer 'G.A. vd. Hoorn <g.a.vanderhoorn@tudelft.nl>, Miguel Prada Sarasola <miguel.prada@tecnalia.com>, Nadia Hammoudeh Garcia <nhg@ipa.fhg.de>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${ur5_e_moveit_config_dep}_FOUND)
      find_package(${ur5_e_moveit_config_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ur5_e_moveit_config_dep} REQUIRED ${depend_list})
  endif()
